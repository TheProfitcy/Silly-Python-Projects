...
name = raw_input("What is your first and last name?").lower()
dob = str(raw_input("What is your date of birth? No spaces. Ex: 05141993"))
...
if name == "noemy garcia" and dob == "09061993":
    frame = simplegui.create_frame("Mystical Octosphere", 50, 100)
    frame_input = frame.add_input("What is your question?", mystical_octosphere, 200)
